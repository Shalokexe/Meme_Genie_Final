...
app = FastAPI(
    ...
    description="Interactive Meme Mind Reader, MemeX Stock Exchange, Hall of Fame, WebSockets Arena, Meme Studio & RAG Engine",
    version="4.1.0-beta"
)
...
# Include game, social, WebSocket, RAG, Leaderboard, and Economy API routes under /api
